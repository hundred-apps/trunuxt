        ...
        <div class="container mx-auto px-0">
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-1 lg:gap-8">
            <div
              ...
              style="max-height: calc(100dvh - var(--header-height, 6rem)); --header-height: 150px;"
            >
              <ProductGallery :product="product" />
            </div>

            <div class="lg:col-span-7 lg:sticky lg:top-[var(--header-height,150px)]" style="--header-height: 150px;">
              <ProductInfo
                :product="product"

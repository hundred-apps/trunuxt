  ...
  <div class="admin-settings">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <aside class="lg:col-span-1">
        <nav
          class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sticky top-24"
        >
          <ul class="space-y-1">
          ...
          <form @submit.prevent="saveAppearance" class="space-y-6">
            ...
            <div>
              ...
              <div class="flex items-center gap-4">
                <img
                  v-if="appearanceSettings.favicon"
        ...
        >
          ...
          <div class="space-y-6">
            <div class="bg-gray-50 rounded-xl p-6">
              <div class="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p class="text-sm text-gray-500">
                    Sinkronkan data produk, artikel, galeri ke Google Sheets
                  </p>
                </div>
                <el-switch
              ...
              <div
                v-if="integrations.googleSheets.enabled"
              ...
              >
                <div>
                  ...
                  >
                  <el-input
                    v-model="integrations.googleSheets.spreadsheetId"
                ...
                <div>
                  ...
                  >
                  <el-input
                    v-model="integrations.googleSheets.serviceAccountKey"
                    type="textarea"
                    :rows="3"
            ...
            <div class="bg-gray-50 rounded-xl p-6">
              ...
              >
                <div>
                  ...
                  >
                  <el-input
                    v-model="integrations.jne.apiKey"
                    type="password"
                    show-password
                    class="w-full"
                  />
                ...
                <div>
                  ...
                  >
                  <el-input
                    v-model="integrations.jne.username"
                    class="w-full"
                  />
                </div>
              </div>
            ...
            <div class="bg-gray-50 rounded-xl p-6">
              <div class="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p class="text-sm text-gray-500">
                    Kirim notifikasi order, promo via WhatsApp
                  </p>
                </div>
                <el-switch
              ...
              <div
                v-if="integrations.whatsapp.enabled"
                class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200"
              >
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1"
                  ...
                  >
                  <el-input
                    v-model="integrations.whatsapp.phoneNumberId"
                    class="w-full"
                  />
                </div>
                <div>
                  ...
                  >
                  <el-input
                    v-model="integrations.whatsapp.accessToken"
                    type="password"
                    show-password
                    class="w-full"
                  />
